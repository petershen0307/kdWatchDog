...
func SaveDataToGoogleSheet(kdInfo []KDResult, stockID string) error {
	googleScriptURL := "https://script.google.com/macros/s/AKfycbwpX0l_OVCz9jV5JpKoBexfyk_8zzgtCRCaySL8hOlarjWaTbox/exec?tab=test"
